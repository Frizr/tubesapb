                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                          child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                            Text('Total Biaya (modal)'),
                            SizedBox(height: 8),
                            Text(uang.format(totalCost),
                                style: TextStyle(fontWeight: FontWeight.bold))
                          ])),
                      Expanded(
                          child: Column(
                            ...
                            Text('Laba / Rugi'),
                            SizedBox(height: 8),
                            Text(uang.format(totalRevenue - totalCost),
                                style: TextStyle(
                  ...
                  ...entries.take(10).map((e) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                          'Terjual: ${v['qty']}  •  Pendapatan: ${uang.format(v['revenue'])}'),
                      trailing: Text(
                          'Profit: ${uang.format((v['revenue'] as int) - (v['cost'] as int))}',
                          style: TextStyle(
                              color: ((v['revenue'] as int) -
                                          (v['cost'] as int)) >=
                                      0
                                  ? Colors.green
                                  : Colors.red)),
